...
<head>
    ...
    <title>500 Server Error - GudangPro Elektronik</title>
    ...
    <div class="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 bg-slate-900 rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/20 border border-slate-800" data-aos="zoom-in">
            ...
            <div class="z-10">
                ...
                <div data-aos="fade-right" data-aos-delay="400">
                    <h2 class="text-4xl font-extrabold leading-tight mb-6">
                        Sistem Sedang <br>
                        <span class="text-blue-200">Dalam Kendala.</span>
                    </h2>
                    <p class="text-blue-100/80 text-lg leading-relaxed max-w-xs">
                        Tim teknis kami sedang berusaha agar platform bekerja efektif kembali.
                    </p>
                </div>
            </div>
        ...
        <div class="p-8 md:p-15 bg-slate-900 flex flex-col justify-center items-center text-center">
            <div class="mb-8" data-aos="fade-down" data-aos-delay="300">
                <div class="inline-block bg-red-500/10 p-6 rounded-full mb-6 border border-red-500/20">
                    <i class="fas fa-server text-5xl text-red-500"></i>
                </div>
                <h1 class="text-6xl font-extrabold text-white mb-2 tracking-tight">500</h1>
                <h3 class="text-2xl font-bold text-slate-200 mb-3">Kesalahan Server</h3>
                <p class="text-slate-400 leading-relaxed max-w-sm mx-auto">
                    Maaf, ada sesuatu yang salah di sisi server kami. Silakan coba muat ulang halaman atau kembali ke Beranda.
                </p>
            </div>

            <div class="w-full max-w-xs space-y-4" data-aos="fade-up" data-aos-delay="500">
                <button onclick="window.location.reload()" 
                    class="w-full bg-slate-700 hover:bg-slate-600 text-white font-bold py-4 rounded-xl border border-slate-600 transition-all active:scale-[0.97] flex items-center justify-center gap-3">
                    <i class="fas fa-sync-alt"></i>
                    <span>Coba Muat Ulang</span>
                </button>
                
                <a href="{{ url('/') }}" 
                    class="w-full bg-transparent hover:bg-blue-900/30 text-blue-400 font-bold py-4 rounded-xl border border-blue-900/50 transition-all active:scale-[0.97] flex items-center justify-center gap-3">
